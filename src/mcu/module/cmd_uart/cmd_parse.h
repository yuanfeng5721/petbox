...
*********************************************************************************************************
*/
#ifndef __CMD_PARSE_CMD_H
#define __CMD_PARSE_CMD_H
...
/** @defgroup DATA_UART_CMD Data Uart Command Module
  * @{
  */
/** @defgroup CMD_PARSE User Command Parse Module
  * @{
  */
/*============================================================================*
 *                         Micros
 *============================================================================*/
/** @defgroup CMD_PARSE_Exported_Micros User Command Parse Module Exported Micros
    @brief  command parse related macros.
    * @{
    */

#define CMD_MAX_COMMAND_LINE       70  /**< max. length of command line in bytes */
#define CMD_MAX_HISTORY_LINE       3   /**< max. num of history command line */
#define CMD_MAX_PARAMETERS         8   /**< max. number of parameters that the parser will scan */
 ...
 *                         Types
 *============================================================================*/
/** @defgroup CMD_PARSE_Exported_Types User Command Parse Module Exported Types
    * @{
    */
...
typedef struct
{
    ...
    uint32_t    dw_param[CMD_MAX_PARAMETERS];  /**< automatically parsed parameters */
    char       *p_param[CMD_MAX_PARAMETERS];   /**< automatically parsed parameters */
} T_CMD_PARSED_VALUE;

/** @brief Command interface. */
typedef struct
{
    char      cmdline_buf[CMD_MAX_COMMAND_LINE + 2];
    uint8_t   cmd_cur;
    uint8_t   cmd_history[CMD_MAX_HISTORY_LINE][CMD_MAX_COMMAND_LINE + 2];
    uint8_t   cmd_history_len[CMD_MAX_HISTORY_LINE];
...
typedef T_CMD_PARSE_RESULT(*T_CMD_FUNC)(T_CMD_PARSED_VALUE *p_parse_value);
...
/** End of CMD_PARSE_Exported_Types
  * @}
  */
 ...
 *                         Functions
 *============================================================================*/
/** @defgroup CMD_PARSE_Exported_Functions User Command Parse Module Exported Functions
    * @{
    */
 ...
 * \endcode
 */
//void cmd_init(T_CMD_IF *p_cmd_if, char *project_name);
...
/** End of CMD_PARSE_Exported_Functions
  * @}
  */

/** @} */ /* End of group CMD_PARSE */
/** @} */ /* End of group DATA_UART_CMD */
#ifdef  __cplusplus
}
#endif  /*  __cplusplus */

#endif  /* __CMD_PARSE_CMD_H */
