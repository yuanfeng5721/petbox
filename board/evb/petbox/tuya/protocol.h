...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "lqheya2v4uxd5ety"//"jee6dpxncjjmuemd"//"lqheya2v4uxd5ety"    //开发平台创建产品后生成的16位字符产品唯一标识
...
******************************************************************************/
//手动喂食(可下发可上报)
//备注:返回值说明： -1代表投食失败； 0~20代表投食份数； 全部投食成功，则返回投食份数；
#define DPID_FEED_NUM 231
//单份食物重量(可下发可上报)
//备注:
#define DPID_FEED_WEIGHT 232
//投喂记录(可下发可上报)
//备注:"""1显示该DP点 
//0不显示该DP点"""
//
#define DPID_HISTORY_DATA 233
//短音录制(可下发可上报)
//备注:"""1: 开启录音 
//0: 关闭录音"""
//
#define DPID_FEED_VOICE_RECORD 234
//实时数据(可下发可上报)
//备注:"""0: 余粮不足
//1: 出粮异常 
//2: 低水位"""
//
#define DPID_REALTIME_DATA 235
//手动喂水(可下发可上报)
//备注:"""1：定量喂水一次；
//0：不喂水""
//"
//
#define DPID_WATER_NUM 236
//余粮显示(只上报)
//备注:设备主动上报当前宠物粮余量，余粮发生变化时上报。类型为数值型，上报0-100的整数。app会处理成百分比。
//
