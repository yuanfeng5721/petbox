...
{
	CONTROL_MSG_INIT,
	CONTROL_MSG_FEEDFOOD_START,
	CONTROL_MSG_FEEDFOOD_STOP,
	CONTROL_MSG_FEEDWATER,
	CONTROL_MSG_FOODSTUCK,
	CONTROL_MSG_WATER_LOW,
	CONTROL_MSG_FOOD_LITTLE,
	CONTROL_MSG_PLAY_VOICE,
	CONTROL_MSG_REPORT_REMAIN,
...
typedef enum
{
    CUSTOM_MSG_BATTERY_STATUS,
	CUSTOM_MSG_BATTERY_POWERMODE,
	CUSTOM_MSG_BATTERY_CAP,
	CUSTOM_MSG_BATTERY_LOWPOWER,
} T_CUSTOM_MSG_TYPE_BATTERY;
...
typedef enum
{
	...
	CUSTOM_WEIGHT_TIMER_ID = 0x500,
	CUSTOM_BATTERY_TIMER_ID = 0x600,
} T_CUSTOM_TIMER_ID;
