...
#define BTLINK_LEN_HEADER           3     //Max Header
#define BTLINK_LEN_PASSWORD         20     //Pincode
#define BTLINK_LEN_SEND_TIME        14    //send time
#define BTLINK_LEN_SERIAL_NUM       4     //Serial number
#define BTLINK_LEN_CONTENT          255   //Content
#define BTLINK_LEN_RESERVED         0     //Reserved arg
...
#define BTLINK_LEN_IMEI         15          //IMEI
#define BTLINK_ERROR_UID            "XXXXXXXXXXXXXXX" //default error UID
#define BTLINK_LEN_FLAG         1           //Flag for enable/disable
#define BTLINK_LEN_PARAMETER    128
#define BTLINK_LEN_SMS_GATE     20
...
/* DBG */
#define BTLINK_LEN_DBG_MODE    4

/* IPS */
#define BTLINK_LEN_IPS_REPORT_MODE 1
#define BTLINK_LEN_IPS_BUFFER_MODE 1
#define BTLINK_LEN_IPS_HOST 60
#define BTLINK_LEN_IPS_PORT 5
#define BTLINK_LEN_IPS_IP   15   
...
/* APN */
#define BTLINK_LEN_APN_NUMS        2
#define BTLINK_LEN_APN_MCC_MNC     5
#define BTLINK_LEN_APN_NAME        40
#define BTLINK_LEN_APN_USER_NAME   30
#define BTLINK_LEN_APN_PASSWORD    30

#define BTLINK_MIN_APN_NUMS 0
#define BTLINK_MAX_APN_NUMS 5
...
#define BTLINK_LEN_LSS_CONT_SEND_INTERVAL  4
#define BTLINK_LEN_LSS_START_MODE          1
#define BTLINK_LEN_LSS_SPEC_TIME_DAY       4
#define BTLINK_LEN_LSS_WAKEUP_INTERVAL     2
#define BTLINK_LEN_LSS_PSM_NET_HOLD_TIME   5
#define BTLINK_LEN_LSS_REPORT_FREG         3
#define BTLINK_LEN_LSS_GNSS_ENABLE         1
#define BTLINK_LEN_LSS_GNSS_FIX_DELAY      2
#define BTLINK_LEN_LSS_AGPS_MODE           1
#define BTLINK_LEN_LSS_BAT_LOW_PERCENT     2
#define BTLINK_LEN_LSS_SENSOR_ENABLE       1
#define BTLINK_LEN_LSS_NON_MOVE_DUR        3
