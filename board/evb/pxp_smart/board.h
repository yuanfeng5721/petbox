...
/*suggest use EVB_8762CK*/
#define EVB_8762CJ_1BIT      0
#define EVB_8762CK           1

#if EVB_8762CJ_1BIT
#define LED      P1_3       //LED2 EVB QFN40 FLASH 1bit
#else
#define LED_M   P0_2        //LED1 EVB QFN48
#define LED_S   P0_1        //LED0 EVB QFN48
#endif

#define BEEP    P3_4       //LED1 EVB QFN48

#define KEY_S      P2_4       //KEY2 EVB QFN48&QFN40
#define KEY_S_IRQ    GPIO20_IRQn
#define KEY_S_INT_Handle  GPIO20_Handler

#define KEY_M      P2_3       //KEY3 EVB QFN48&QFN40
#define KEY_M_IRQ    GPIO19_IRQn
#define KEY_M_INT_Handle  GPIO19_Handler
